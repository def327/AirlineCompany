...
public class CreateAirlineCompanyAction {
	...
	public static void runAction(AirlineManageSystem airlineCompanyManager, Scanner consoleReader) {
		...
		String airlineCompanyName = choseNameForNewAirlineCompany(airlineCompanyManager, consoleReader, airlineCompanyBuilder);	
	...
	/**
	 *  !!! Chose a name from list for a new airline company
	 *  
	 * @param airlineCompanyManager
	 * @param consoleReader
	 * @param airlineCompanyBuilder
	 */
	private static String choseNameForNewAirlineCompany(AirlineManageSystem airlineCompanyManager, Scanner consoleReader,
			BuilderAirlineCompany airlineCompanyBuilder) {
	...
	/**
	 *  !!! This method create airline company using only selected airline company name
	 * @param airlineCompanyManager
	 * @param airlineCompanyBuilder
	 */
	private static void createAirlineCompany(AirlineManageSystem airlineCompanyManager,	BuilderAirlineCompany airlineCompanyBuilder, String airlineCompanyName) {
	...
	/**
	 *  !!! This method show full to console information about new created airline company
	 * @param airlineCompanyManager
	 */
